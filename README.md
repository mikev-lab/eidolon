...
* **[Developer Best Practices (`docs/DEVELOPER_BEST_PRACTICES.md`)](./docs/DEVELOPER_BEST_PRACTICES.md):** Integration runbook, intent streaming, mechanical sympathy, and zero-allocation gameplay loops.
* **[Persistence & Database Integration (`docs/PERSISTENCE_AND_DATABASE_INTEGRATION.md`)](./docs/PERSISTENCE_AND_DATABASE_INTEGRATION.md):** Production PostgreSQL schema, asynchronous WAL sinks, account hibernation, and building chunk storage.
